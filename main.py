...
def display_board(player_name, current_level, game_score, carbon_footprint, current_airport ):
    print(f"""
...
display_board(player_name, current_level, game_score, carbon_footprint, current_airport)
